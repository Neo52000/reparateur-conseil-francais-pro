...
serve(async (req) => {
  ...
  try {
    ...
    const { operation, url, options } = await req.json();
    ...
    console.log(`🔥 Calling Firecrawl ${operation} for URL:`, url);
    ...
    console.log('✅ Firecrawl request successful');
    ...
    console.error('❌ Error in firecrawl-proxy:', error);
    return new Response(
      JSON.stringify({ 
        success: false, 
