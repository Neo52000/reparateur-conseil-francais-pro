...
-- Supprimer la contrainte de défaut avant la conversion
ALTER TABLE public.optional_modules_config 
ALTER COLUMN available_plans DROP DEFAULT;

-- Convertir available_plans d'ARRAY vers JSONB
ALTER TABLE public.optional_modules_config 
ALTER COLUMN available_plans TYPE JSONB USING to_jsonb(available_plans);

-- Remettre une nouvelle valeur par défaut JSONB
ALTER TABLE public.optional_modules_config 
ALTER COLUMN available_plans SET DEFAULT '["basic", "premium", "enterprise"]'::jsonb;
