-- Création des pages services manquantes dans static_pages
...
(
  ...
  '<div class="service-page">
    ...
    <ul>
      ...
      <li>Pièces de qualité d\'origine</li>
...
-- Création d'un template de base pour les pages SEO locales pour tous les services
