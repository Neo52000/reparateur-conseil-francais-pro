-- Phase 4: Intégration et synchronisation - Données de démonstration
...
INSERT INTO ecommerce_products (repairer_id, sku, name, slug, description, price, cost_price, stock_quantity, category, status, featured_image_url, manage_stock, stock_status, shipping_required)
SELECT 
  user_id,
  'SCR-IP13-001',
...
INSERT INTO ecommerce_stores (repairer_id, store_name, domain, status, plan_type, monthly_orders, monthly_revenue, conversion_rate, store_settings, template_id)
SELECT 
  user_id,
...
-- Synchronisation automatique pour maintenir la cohérence des données
-- Trigger pour synchroniser les stocks entre POS et E-commerce
