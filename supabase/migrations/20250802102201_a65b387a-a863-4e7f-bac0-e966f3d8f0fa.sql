-- Phase 3: Tables pour éliminer les simulations (correction)
...
('backup_retention_days', '"30"', 'Retention days for backups'),
('max_concurrent_users', '"1000"', 'Maximum concurrent users'),
('maintenance_mode', '"false"', 'Maintenance mode enabled'),
('performance_monitoring', '"true"', 'Performance monitoring enabled');
