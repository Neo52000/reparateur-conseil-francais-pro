...
export const useRepairManagement = () => {
  ...
  const createRepairOrder = async (deviceData: Partial<RepairDevice>) => {
    ...
    try {
      ...
      // Then create the repair order - order_number will be auto-generated by trigger
      ...
      if (orderError) {
        ...
        throw new Error(`Erreur lors de la création de l'ordre de réparation: ${orderError.message}`);
      }
