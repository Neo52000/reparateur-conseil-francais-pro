...
import { MapPin, MessageCircle, Mail, Globe, Navigation, Phone } from 'lucide-react';
      ...
      <CardContent className="p-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <Button variant="outline" size="sm" onClick={handleGetDirections} className="flex-shrink-0">
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button variant="outline" size="sm" onClick={handleCall} className="flex-shrink-0">
              Appeler
            </Button>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button variant="outline" size="sm" onClick={handleWhatsApp} className="flex-shrink-0">
              WhatsApp
            </Button>
          </div>
          ...
          <div className="flex items-center space-x-3">
            ...
            <Button variant="outline" size="sm" onClick={handleEmail} className="flex-shrink-0">
              Écrire
            </Button>
          </div>
          
          {profile.website && <div className="flex items-center space-x-3">
              <Globe className="h-5 w-5 text-purple-600 flex-shrink-0" />
              <div className="flex-1">
                <a href={profile.website} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">
                  Site web
                </a>
              </div>
            </div>}
