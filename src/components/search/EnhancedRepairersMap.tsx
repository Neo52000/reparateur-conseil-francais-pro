...
import { X, Phone, Mail, MapPin, Star, Clock, Award, Shield, User, Menu } from 'lucide-react';
...
const EnhancedRepairersMap: React.FC<EnhancedRepairersMapProps> = ({ 
  ...
  useEffect(() => {
    if (mapSelectedRepairer) {
      ...
      setSidebarOpen(true); // Auto-open sidebar when repairer is selected
    }
  }, [mapSelectedRepairer]);
